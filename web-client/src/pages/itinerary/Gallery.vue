      ...
      <v-row no-gutters>
        <v-col cols="12" md="9">
          <v-card
            :style="{
              ...
              position: 'relative',
              backgroundImage:
                'linear-gradient( rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8) ), url(https://images.pexels.com/photos/2413238/pexels-photo-2413238.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260)',
            }"
        ...
        <v-col cols="12" md="3">
          ...
          >
            ...
            <v-card-title>Itinerary Gallery</v-card-title>
